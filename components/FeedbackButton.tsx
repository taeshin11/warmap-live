  ...
  return (
    <>
      ...
      <div className="fixed bottom-20 right-4 md:bottom-8 md:right-6 z-[70] flex flex-col items-end gap-2">
        {open && (
          <div className="bg-white rounded-2xl shadow-2xl border border-slate-200 p-5 w-72 animate-in slide-in-from-bottom-2 duration-200">
            ...
            <p className="text-xs text-slate-600 mb-4">
              Have a feature request, spotted an error in our data, or want to suggest an improvement?
            </p>
            <a
        ...
        <button
          onClick={() => setOpen(v => !v)}
          className="flex items-center gap-1.5 bg-slate-800 hover:bg-slate-700 text-white text-xs font-medium px-3 py-2 rounded-full shadow-lg transition-all hover:scale-105 active:scale-95"
